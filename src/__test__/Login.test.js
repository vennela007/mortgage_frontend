...
describe('When Controlled component is given', () => {
    ...
    it('should render student id field', ()=> {
        expect(wrapper.find('#loginId')).toHaveLength(1);
    });
    ...
    describe('When onChange event is not triggered on student Id field', () => {
        it('should have empty state', () => {
          expect(wrapper.state().loginData.loginId).toEqual('');
        });
      });
      ...
      describe('When onChange event triggered on studentId field', () => {
        beforeEach(() => {
          const loginId = wrapper.find('#loginId');
          loginId.simulate('change', { target: { name:'loginId',value: '12345' } });
        })
      ...
      describe('When submit button is clicked', () => {
        beforeEach(() => {
          wrapper.find('#loginId').simulate('change', { target: {name:'loginId', value: '12345' } });
